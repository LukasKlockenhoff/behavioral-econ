...
Von 105 Teilnehmenden sind 64 weiblich, 43 männlich und eine diverse Person.
...
Das folgende Kapitel wertet den Effekt des Framings auf die Handlungsbereitschaft und Risikobereitschaft in den drei Probandengruppe aus.

\subsection{Effekt von Framing auf die Handlungsbereitschaft}
Die Handlungsbereitschaft wurde mithilfe der Thesen erfasst, die in \cref{chap:methodik} beschrieben wurden. Die Probanden der Gruppe 1, die eine Gewinn-Framing Nachricht erhalten haben, zeigen die höchste durchschnittliche Handlungsbereitschaft mit einem Mittelwert von 3,841. Die Probanden der Gruppe 2 unterscheiden sich mit einem Mittelwert von 3.761 nur geringfügig von Gruppe 1. Auch der Mittelwert der Gruppe 3, die eine dramatisierte Verlust-Framing Nachricht erhalten hat, liegt mit 3.74 nahe an den anderen Gruppen.
...
\subsection{Effekt von Framing auf die Risikowahrnehmung}
